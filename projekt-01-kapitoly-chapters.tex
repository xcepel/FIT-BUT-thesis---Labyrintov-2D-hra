...
% Dotazník
\section{Dotazník}
Otázky byly vytvářeny tak, aby se protestovaly hlavní aspekty vytvořené hry, kterými jsou její hratelnost, uživatelské rozhraní, stabilita programu a celková náročnost hry. Vzhledem k tomu, že byl dotazník vypracován pro hromadné testování, jsou otázky formulovány tak, aby umožňovaly spíše výběr z předem definovaných možností/škál, než aby vyžadovaly volné textové odpovědi, a to kvůli jednoduššímu vyhodnocování. \\
\newline
\noindent Seznam otázek:
\begin{enumerate}
\item Kolik času jste strávili u hraní?
    \begin{itemize}
        \item otevřená otázka
    \end{itemize}
...
\item Jaký je váš celkový dojem ze hry?
    \begin{itemize}
        \item uzavřená otázka (velmi negativní\,--\,velmi pozitivní)
    \end{itemize}
\item Jak byste ohodnotili uživatelské rozhraní a celkovou přehlednost hry?
    \begin{itemize}
        \item uzavřená otázka (velmi nepřehledné\,--\,velmi přehledné)
    \end{itemize}
\item Jak byste ohodnotili stabilitu a výkon hry (záseky/pády, \ldots)?
    \begin{itemize}
        \item uzavřená otázka (velmi stabilní\,--\,nestabilní)
    \end{itemize}
\item Co pro vás bylo nejtěžší?
    \begin{itemize}
        \item polo-uzavřená otázka (orientace v bludišti, boj/vyhýbání se nepřátelům, technické chyby, ovládání, jiné:\ldots)
    \end{itemize}
\item Jak byste ohodnotil vyváženost zvyšující se obtížnosti?
    \begin{itemize}
        \item uzavřená otázka (velmi nevyvážená\,--\,velmi vyvážená)
    \end{itemize}
\item Pokud jste hodnotili hru jako spíše nevyváženou, jaký k tomu byl důvod? (vyberte co platí, popřípadě doplňte)
    \begin{itemize}
        \item polo-uzavřená otázka (obtíýnost se zvyšuje moc pomalu/rychle, na začátku moc jednoduchá a na konci moc složitá, jiné:\ldots)
    \end{itemize}
...
Celkový dojem hráčů ze hry byl spíše kladný. Největší problém byl se způsobem počítání skóre, u kterého připouštím, že první verze nebyla dokonalá. Hlavním problémem bylo, že skóre bylo rozděleno dle stupňů, které nebyly rozděleny adekvátně, tak aby odpovídaly jejich společné časové náročnosti. To následně vytvořilo problém, že někteří hráči získávali za vyšší úrovně skóre záporné.

Dalším problémem, na který několik testerů upozornilo byla absence legendy, či vysvětlení významu a vlastností objektů ve hře (předmětů a nepřátel). To také vyvolávalo zmatení u některých předmětů, jelikož hráči očekávali jinou funkci\,--\,například item truhly původně po sebrání jen zmizel bez dodatečných efektů, což u hráče vyvolalo zmatení, jelikož očekával, že dostane nějaký bonusový předmět, i přestože truhla dodává pouze bonusové skóre.

Našlo se také několik drobných technických problémů a to u kamery s pohledem na hráče, jenž nebyla vhodně vycentrovaná a optimalizovaná pro rychlost hratelné postavy, čímž se hráči setkávali s problémem že kamera \uv{nestíhala} zabírat postavičku při vertikálním pohybu a nastávaly neočekávané kolize.

Kladný byl i názor na složitost hry a její postupné zvyšování obtížnostní úrovně, i když se našli někteří kteří nepocítili rozdíly mezi různými úrovněmi.

Na základě zpětné vazby na složitost byly i upraveny někter
\subsection*{Uživatelské rozhraní}
I uživatelské rozhraní hodnotili uživatelé kladně s drobnými chybičkami. Hráči oceňovali nápaditost a grafickou stránku hry.
...
\subsubsection*{Hratelnost}
Oprava počítání skóre, nová rovnice + člověk nemůže jít do záporu

Oprava kamery - zvýšena rychlost posunu, aby panáček zůstával v centru obrazovky, což by mělo ulehčit i viditelnost nepřátel a zabránění neočekávaným kolizím s nimi

Předělán item bot, zvyšuje rychlost na celou dobu + násobitelný jako meč

Zjednodušen zpomalovací mob/slime\,--\,jeho zpomalení se nově nenásobí, pouze se obnovuje časovač zpomalení + změněno HP 10 -> 8

Legenda/vysvětlení objektů ve hře (itemy + nepřátelé)\,--\,přidaní stránky \uv{GUIDE}, kde se nachází stránky s vysvětlením základů hry (ovládání, hlavní cíle hry\,--\,pro přehled získávání skóre a zdůraznění životů), vysvětlení itemů, vysvětlení vlastností nepřátel a pastí

Diagonální pohyb hráče je v aktualizované formě stejně rychlý jak pohyb vertikální/horizontální, čehož bylo docíleno pomocí normalizace.

Synchronizace animace útoku a vyslání signálu útoku u hráče

Odstranění nepřítele divočáka\,--\,nevhodný do prostorů bludiště, moc se zasekával o zdi, nebylo to možné opravit

Řazení skóre\,--\,implementován bubble sort místo nativního sortu

\subsubsection*{Uživatelské rozhraní}
Sbírání mečů\,--\,již dříve se násobili, ale nebylo to nijak uživateli dáno na vědomí, předělána ikona, aby obsahovala i rámeček s počtem

Sbírání bot\,--\,předělána ikona, aby obsahovala i rámeček s počtem zrychlení

Zlepšena viditelnost zvoleného tlačítka pomocí rámečku + změněn focus a hover mode tlačítek

Možnost zrušení pauzy hry pomocí klávesy Esc

Zamrznutí obrazovky po dohrání úrovně/hry aby bylo zabráněno missclicku + potvrzovací okna o navrácení do menu a ukončení hry u dohrání úrovně/hry/pauzy

Zobrazování času stráveném v úrovni ve hře

Oprava textury pasti

Animace přidání skóre u truhly

Změna nastavení fullscreen na windowed fullscreen

\subsubsection*{Stabilita programu}
Po dohraní a zadaní jména (bez diakritiky) a zmačknutí éteru hra spadla\,--\,nešlo zreplikovat, ale přidána ikonka na potvrzení uložení jména

\subsubsection*{Náročnost}
Změna algoritmu pro přidávání nepřátel do hry, nepřátele se objeví ve hře o kolo dřív a dále se objevují častěji pro zvýšení náročnosti hry.

Pro vyhýbání se nepřátelům snížena jejich viditelnost/vzdálenost od kdy začnou pronásledovat hráče na 3 bloky a drobné zmenšeni jejich modelů

\subsection*{Zavrhnuté návrhy a návrhy pro budoucí práci}
Ukazování předmětů, které je možné získat\,--\,bloudění, možná v budoucnu pro lehčí mód

Odhalovací minimapa\,--\,možná v budoucnu pro lehčí mód či později u složitějších/výšších úrovní

Hudba

Úprava panáčka za sesbírané skóre

Zobrazování skóre ve hře\,--\,kvůli způsobu počítání skóre by to bylo matoucí, místo toho přidán čas

Větší prostory\,--\,do budoucna

Poznačování prošlých úseků\,--\,do budoucna pomocí itemu (spotřebovatelné itemy)

Změna velkosti kamery/plochy kterou hráč vidí\,--\,naschvál, má to udržet pocit bloudění v bludišti

Po skončení ukázání mapy labyrintu\,--\,možná v budoucnu, ale jen zapnutelná možnost, bylo by to moc rušivé

Prostestováno spawnování portálu (konce hry) a nepřátel, vše se objevuje dle algoritmů.
%===---------------====
% ZAVER
%===---------------====
\chapter{Závěr}
