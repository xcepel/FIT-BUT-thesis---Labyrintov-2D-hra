...
\newline \newline
\noindent Proces vývoje videoher je možné rozdělit na 7 základních etap~\cite{pickell2019a}:
\begin{itemize}
    \item Plánování
    \item Před-produkce
    \item Produkce
...
V deštní době se vývoj videoher rozděluje na \todo{indie x AAA}

%--------------------------
% Začátek videoher
\section{Začátek videoher}
První počítačové hry vznikaly kolem 50. let 20. století na vojenských základnách a univerzitách a jejich sálových počítačích~\cite{novak2011game}\,--\,těmito videohrami byla například OXO (1952), Tennis for Two (1958), ale do nepopulárnějších videoher (vytvořených v té době) se počítá hlavně hra vytvořena MIT studentem Stevem Russellem  \uv{Spacewar!}~\cite{bellis2019spacewar}, jenž je vidět na obrázku~\ref{fig:spacewar}. 

\begin{figure}[H]
    \centering
	\includegraphics[width=0.6\textwidth]{obrazky-figures/ch2/Spacewar.png}
	\caption{Ukázka hry \uv{Spacewar}.~\cite{bellis2019spacewar}}
	\label{fig:spacewar}
\end{figure}
...
\begin{itemize}
    \item Atari\,--\,roku 1976 vydali jednu z prvních konzolí Atari VCS/2600, která odstartovala velkoprodej domácích konzolí~\cite{novak2011game}.
        \begin{itemize}
        \item Tato konzole přišla s mnoha, pro svojí dobu, ikonickými hrami, které byly často předělané tituly známe z arkád, jako je například Pac-Man série, Space Invaders, Asteroids, Q*bert, Pole Position či Frogger~\cite{Atari_games}.
    \end{itemize}
    \item Nintendo\,--\,jejich první konzole, NES, byla vydána roku 1985.
    \begin{itemize}
        \item Vyšlo na ni mnoho dodnes populárních herních titulů, jako je například The~Legend of~Zelda, Super Mario Bros, Final Fantasy, Dragon Quest nebo Tetris~\cite{NES_GAMES}.
    \end{itemize}
...
S příchodem personálních počítačů do domácností se zvýšil zájem o hry, mnoho původně pouze univerzitních her, bylo adaptováno do personálních počítačů, což způsobilo úpadek placených arkádových her~\cite{novak2011game}, jelikož teď měl přístup ke hrám každý, kdo vlastnil počítač. 

V dnešní době jsou možnosti pro hraní videoher ještě rozšířenější, od možnosti hrát na telefonech, vyvinutějších ručních konzolích, či dokonce virtuální realita.
...
Uživatelské testování bylo prováděno formou online anonymního dotazníku (Google Forms), který testované subjekty vyplnily po otestování hry. Hra byla testována na počítačích s Windows a Linux operačními systémy. Testery byli aktivní i nezkušení hráči her, naverbováni primárně díky sdílení testovacích prostředků na sociálních sítích.

%--------------------------
% Dotazník
\section{Dotazník}
Otázky jsem vytvářela tak, abych protestovala hlavní aspekty vytvořené hry, které bych následně mohla upravit, či předělat na základně zpětné vazby. Testovanými aspekty jsou její hratelnost, uživatelské rozhraní a stabilita programu a  náročnost. Vzhledem k tomu, že byl dotazník vypracován pro hromadné testování, jsou otázky formulovány tak, aby umožňovaly výběr z předem definovaných možností, než aby vyžadovaly volné textové odpovědi, a to kvůli jednoduššímu vyhodnocování.
\newline \newline
...
\item Jak byste ohodnotili stabilitu a výkon hry (záseky/pády,...)?
